...
import net.mcreator.backhomemod.item.EmeraldapickelItem;
...
public class BackHomeModModItems {
	...
	public static final RegistryObject<Item> COMPRESSEDCOPPERBLOCK = block(BackHomeModModBlocks.COMPRESSEDCOPPERBLOCK, BackHomeModModTabs.TAB_AZIMOD);
	...
	public static final RegistryObject<Item> EMERALDAPICKEL = REGISTRY.register("emeraldapickel", () -> new EmeraldapickelItem());

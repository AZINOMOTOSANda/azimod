 ...
 *
 */
package net.mcreator.backhomemod;
...
@Mod("back_home_mod")
public class BackHomeModMod {
	public static final Logger LOGGER = LogManager.getLogger(BackHomeModMod.class);
	public static final String MODID = "back_home_mod";
